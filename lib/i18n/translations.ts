 ...
 * i18n 번역 데이터
 *
 * 단일 책임: 모든 지원 언어의 번역 문자열 데이터만 포함합니다.
 * 타입 정의는 types.ts, 상태 관리는 locale-context.tsx 에 있습니다.
 */
import type { LocaleCode, TranslationStrings } from "./types"
...
export const translations: Record<LocaleCode, TranslationStrings> = {
  ko,
  en,
  ja: { ...en, ...jaBase },
  es: { ...en, ...esBase },
